...
public:
    ...
    //Function written for exercise 1
    ...
    elemType min() const;
    //Function written for Exercise 3

    elemType max() const;
    //Function written for Exercise 4
...
template <class elemType>
void arrayListType<elemType>::removeAtEx1(int location)
{
    if (location < 0 || location >= length)
        cerr << "The location of the item to be removed "
        << "is out of range" << endl;
...
arrayListType<elemType>::arrayListType(int size)
{
    ...
    assert(list != NULL);           //if argument false, terminate
}
...
(const arrayListType<elemType>& otherList)      //const before return type to avoid (a=b)=c kind of coding
{
